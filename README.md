...
| 项目 | 状态 |
| --- | --- |
| 🕐 最后更新时间 | 2026-09-13 01:48:33 (UTC+8) |
| 📏 规则总数 | 1,084,417 条 |
| 🔄 更新频率 | 每 5 小时自动更新 |
...
<!-- AUTO_UPSTREAM_START -->
<details>
<summary>📋 点击展开完整上游源列表（共 45 个）</summary>
...
| 44 | `sutchan/DNS_Shield` | [链接](https://raw.githubusercontent.com/sutchan/DNS_Shield/main/public/adguard.txt) |
| 45 | `ph00lt0/blocklist` | [链接](https://raw.githubusercontent.com/ph00lt0/blocklist/master/blocklist.txt) |
</details>
<!-- AUTO_UPSTREAM_END -->
<!-- 🔼 脚本会自动替换此标记之间的内容 🔼 -->
